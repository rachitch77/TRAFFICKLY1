        ...
        >
          <div className="flex items-start gap-3 rounded-xl border border-yellow-500/40 bg-yellow-500/10 px-5 py-4">
            ...
            <p className="text-sm text-yellow-200 leading-relaxed">
              <span className="font-semibold text-yellow-300">Important:</span> The contact form and our Traffickly email are not active yet. Please send all queries directly to our founder at{" "}
              <a
